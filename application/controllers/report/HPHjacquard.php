...
class HPHjacquard extends MY_Controller
{
    ...
    function loadData()
	{
		...
		// 	$callback = array('status' => 'failed', 'message' => 'Maaf, Tanggal tidak boleh lebih dari 31 hari !', 'icon' =>'fa fa-warning', 'type' => 'danger'  ); 
	...
	public function export_excel_hph()
	{
		...
		$object->getActiveSheet()->mergeCells('A2:B2');
 		$object->getActiveSheet()->SetCellValue('C2', ': Jacquard');
