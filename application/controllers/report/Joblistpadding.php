 ...
 * 
 */
class Joblistpadding extends MY_Controller
{
	...
	public function index()
	{
        ...
        $data['id_dept_asli'] = 'PAD' ;
		$this->load->view('report/v_job_list_padding', $data);
	}
    ...
    public function get_data()
	{
        ...
        foreach ($list as $field) {
            ...
            $link_kain      = '<a href="'.base_url('warehouse/penerimaanbarang/edit/'.$kode_in_kain_enc).'" target="_blank" data-toggle="tooltip" title="No PAD IN :'.$kode_in_kain.'"" '.$color.'>'.$alias_stat_kain.'</a>';
            ...
            $status_mg     = '<a href="'.base_url('manufacturing/mO/edit/'.$kode_encrypt).'" target="_blank" data-toggle="tooltip" title="MG PAD '.$kode_mrp.'" '.$color3.'>'.$nama_status.'</a>';
