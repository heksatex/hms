	...
	public function get_data()
	{
        ...
        foreach ($list as $field) {
            ...
            */
            ...
            // get_ move id out
            $mv = $this->m_joblistdyeing->get_move_id_by_sourve_move($move_id_fg)->row_array();
            $move_id =  $mv['move_id'];
            //get move_id out by move_id prod
            $outs = $this->m_joblistdyeing->get_pengiriman_barang_by_move_id($move_id)->row_array();
            $kode_out  = $outs['kode'];
            $qc1_out   = $outs['qc_1'];
            $qc2_out   = $outs['qc_2'];
            $qc            = $this->m_joblistdyeing->get_quality_control_by_kode($kode_out,$field->dept_id)->row();
