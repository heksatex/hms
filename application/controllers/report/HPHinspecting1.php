 ...
 * 
 */
class HPHinspecting1 extends MY_Controller
{
    ...
    function loadData()
	{
		...
		if(strtotime($tglsampai) < strtotime($tgldari) ){
			...
			$callback = array('status' => 'failed', 'message' => 'Maaf, Periode Tanggal tidak boleh lebih dari 30 hari !', 'icon' =>'fa fa-warning', 'type' => 'danger'  ); 
	...
	public function export_excel_hph()
	{
		...
		ob_end_clean();
		$name_file = "HPH Inspecting1.xlsx";
		$response =  array(
			'op'        => 'ok',
