 ...
 * 
 */
class Joblistsetting extends MY_Controller
{
	...
	public function index()
	{
        ...
        $data['id_dept_asli'] = 'SET' ;
		$this->load->view('report/v_job_list_setting', $data);
	}
    ...
    public function get_data()
	{
        ...
        foreach ($list as $field) {
            ...
            $link_kain      = '<a href="'.base_url('warehouse/penerimaanbarang/edit/'.$kode_in_kain_enc).'" target="_blank" data-toggle="tooltip" title="No SET IN :'.$kode_in_kain.'"" '.$color.'>'.$alias_stat_kain.'</a>';
            ...
            $status_mg     = '<a href="'.base_url('manufacturing/mO/edit/'.$kode_encrypt).'" target="_blank" data-toggle="tooltip" title="MG SET '.$kode_mrp.'" '.$color3.'>'.$nama_status.'</a>';
