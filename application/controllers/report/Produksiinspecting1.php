 ...
 * 
 */
class Produksiinspecting1 extends MY_Controller
{
	...
	{	
		...
		$this->load->view('report/v_produksi_inspecting1', $data);
	}
    ...
    function export_excel()
    {
        ...
        $object->getActiveSheet()->SetCellValue('A1', 'Jadwal Produksi Inspecting1');
