 ...
 * 
 */
class HPHdyeing extends MY_Controller
{
    ...
    public function index()
	{
		...
		$data['mesin']  = $this->_module->get_list_mesin_report('DYE');
		$data['mst_sales_group'] = $this->_module->get_list_sales_group();
		$this->load->view('report/v_hph_dyeing', $data);
	}
	...
	public function export_excel_hph()
	{
		...
		// header table
    	// $table_head_columns  = array('No', 'MG', 'No Mesin', 'SC', 'Tgl HPH', 'Kode Produk', 'Nama Produk', 'Lot', 'Qty1', 'Uom1','Qty2', 'Uom2','Grade','Lebar','Greige','Jadi','Marketing','Reff Note','Lokasi','No GO','User');
