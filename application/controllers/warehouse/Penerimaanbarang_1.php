...
//        $supp_nm = $this->input->post('supplier_nm');
...
//                    $this->m_penerimaanBarang->update_penerimaan_barang($kode, $reff_note);
                    $this->m_penerimaanBarang->update_perbatch("UPDATE penerimaan_barang set reff_note = '{$reff_note}'"
                            . " ,tanggal_sj = '{$tgl_sj}', no_sj = '{$no_sj}' WHERE kode = '$kode'");
