      ...
      if (empty($txtlot)) {
        ...
        if ($get) {
          ...
          foreach ($out as $outs) {
            ...
            $result_record[] = array(
              'tanggal' => $outs->tanggal_transaksi,
              'kode'    => $outs->kode,
          ...
          foreach ($rmt as $rmts) {
            ...
            $result_record[] = array(
              'tanggal' => $rmts->tanggal_transaksi,
              'kode'        => $rmts->kode,
          ...
          foreach ($rmh as $rmhs) {
            ...
            $result_record[] = array(
              'tanggal' => $rmhs->tanggal_transaksi,
              'kode'         => $rmhs->kode,
              'link'       => 'manufacturing/mO/edit/' . $kode_encrypt,
          ...
          foreach ($join as $joins) {
            ...
            $result_record[] = array(
              'tanggal' => $joins->tanggal_transaksi,
          ...
          foreach ($manual as $manuals) {
            ...
            $result_record[] = array(
              'tanggal' => $manuals->tanggal_transaksi,
              'kode'        => $manuals->kode,
          ...
          foreach ($picklist as $picklists) {
            ...
            $result_record[] = array(
              'tanggal' => $picklists->tanggal_masuk,
