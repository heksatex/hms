...
class Rekapentries extends MY_Controller {
...
//        }
    ...
    public function index() {
        ...
        $this->load->view('report/acc/v_rpt_rekap_entries', $data);
    }
    ...
    public function search() {
        ...
        try {
            ...
            $html = $this->load->view('report/acc/v_rpt_rekap_entries_detail', $data, true);
