...
class Girokeluar extends MY_Controller {
    ...
    public function simpan() {
        try {
            ...
            $this->_module->gen_history($sub_menu, $nogk, 'create', "DATA -> " . logArrayToString("; ", $header) . "\n Detail -> " . logArrayToString("; ", $detail), $username);
    ...
    public function update_status($id) {
        ...
        try {
            ...
            $this->_module->lock_tabel("token_increment WRITE,acc_giro_keluar WRITE,acc_giro_keluar_detail WRITE,log_history WRITE"
                    . ",main_menu_sub READ,acc_jurnal_entries_items WRITE,acc_jurnal_entries WRITE,currency_kurs READ,acc_kas_masuk_detail READ");
...
//                    $checkKasMasuk = $model
                    ...
                    $this->_module->gen_history("jurnal_entries", $head->jurnal, 'edit', "Merubah Status Ke unposted dari Giro Keluar", $username);
