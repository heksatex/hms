...
//                }
    ...
    public function show($id) {
        try {
            ...
            $data['id_dept'] = 'CFB';
            $data["id"] = $id;
            $data["datas"] = $this->m_cfb->setWheres(["kode_cfb" => $kode_decrypt])->setSelects(["cfb.*,departemen.nama as nama_warehouse"])
...
//            $username = $this->session->userdata('username');
            ...
            $updt->setTables('cfb_items ci')->setWhereRaw("id in (" . implode(",", $ids) . ")")->setWheres(['status' => 'draft'])->update(['status' => $status]);
