                    ...
                    <div class="box">
                        ...
                        <form class="form-horizontal" id="form-produk-add" name="form-produk-add" method="POST" action="<?php echo base_url('warehouse/produk/simpan') ?>" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <input name="kode_produk_before" id="kode_produk_before" type="hidden">
                                <input name="nama_produk_before" id="nama_produk_before" type="hidden">
...
//        $("#fotos").val(document.getElementById("foto").files[0]);
            ...
            $("#kode_produk_before").val("<?= $produk->kode_produk ?>");
            $("#nama_produk_before").val("<?= htmlentities($produk->nama_produk) ?>");
