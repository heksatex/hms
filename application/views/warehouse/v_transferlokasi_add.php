            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-12 col-xs-12">
                  ...
                  <div class="col-xs-8 col-md-8">
                     <input type='text' class="form-control input-sm " name="tgl_generate" id="tgl_generate" readonly="readonly"   />
                  </div>                                    
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-12 col-xs-12">
                  ...
                  <div class="col-xs-8">
                    <input type="text" class="form-control input-sm" name="lokasi_tujuan" id="lokasi_tujuan"  placeholder="Scan Lokasi">
                  </div>                                    
                </div>                
              </div>
