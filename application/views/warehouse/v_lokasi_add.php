            ...
            <div class="form-group">   
              ...
              <div class="col-md-8 col-xs-8">
                  <div class="col-md-3"><label style="font-size: 30px">A </label> <label>Aisle</label>
                    <input type="text"  class="form-control" name="aisle" id="aisle"  placeholder="A"  onkeyup="return myFunction(this,'bay')" maxlength="3" >
                  </div>
                  ...
                  <div class="col-md-3"><label style="font-size: 30px">S </label> <label>Slot</label>
                    <input type="text"  class="form-control" name="slot" id="slot" placeholder="S"  onkeyup="return myFunction(this,'kode_lokasi')" maxlength="2" >
                  </div>
              </div>     
            </div>       
            <div class="form-group">                  
              <div class="col-md-6 ">
                <div class="col-md-5"><label>Kode Lokasi / Nama Lokasi</label></div>
                  <div class="col-md-7 ">
                   <input type="text" class="form-control" name="kode_lokasi" id="kode_lokasi" readonly="readonly"> 
                  </div>                                    
