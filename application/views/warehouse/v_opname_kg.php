              ...
              <div class="form-group"> 
                ...
                <div class="col-md-12 col-xs-12">
                  <div class="col-xs-4"><label>Lokasi Fisik</label></div>
                   <div class="col-xs-8">
                      <input type="text" class="form-control input-sm" name="lokasi_fisik" id="lokasi_fisik"  />
                    </div>                                    
                </div>
              </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#example1').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('warehouse/opnamekg/get_data')?>",
                "type": "POST",
                 "data": function ( data ) {
                    data.dept_id      = $('#departemen').val();
                    data.lokasi_fisik = $('#lokasi_fisik').val();
        ...
        $('#lokasi_fisik, #nama_produk, #lot').keypress(function(event){
