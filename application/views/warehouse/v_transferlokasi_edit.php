...
<head>
  ...
  ?>
    <style>
      button[id="btn-scan"]{/*untuk hidden button simpan/cancel di top bar MO*/
        display: none;
      }
    </style>
<?php 
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-12 col-xs-12">
                  ...
                  <div class="col-xs-8 col-md-8">
                     <input type='text' class="form-control input-sm " name="tgl_buat" id="tgl_buat" readonly="readonly" value="<?php echo $tl->tanggal; ?>" />
                  </div>                                    
                </div>
                <div class="col-md-12 col-xs-12">
                  <div class="col-xs-4"><label>Tanggal Generate </label></div>
                  <div class="col-xs-8 col-md-8" id="tgl_gen">
                     <input type='text' class="form-control input-sm " name="tgl_generate" id="tgl_generate" readonly="readonly" value="<?php if($tl->tanggal_generate != '0000-00-00 00:00:00'){echo $tl->tanggal_generate; }; ?>" />
                  </div>                                    
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-12 col-xs-12">
                 ...
                 <div class="col-md-12 col-xs-12">
                  <div class="col-xs-4"><label>Scan Barcode</label></div>
                  <div class="col-xs-8">
                            ...
                            ?>
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <a onclick="hapus_items('<?php  echo $tl->kode_tl ?>','<?php  echo $row->row_order ?>','<?php echo $row->nama_produk ?>','<?php  echo $row->quant_id ?>','<?php  echo $row->lot ?>')"  href="javascript:void(0)" data-toggle="tooltip" title="Hapus Data"><i class="fa fa-trash" style="color: red"></i> </a>
                                    <?php }?>
 ...
 //untuk merrefresh 
  ...
  function cek_validasi(){
    ...
    $.ajax({
        ...
        type    : "POST",
        data    : {kode:$('#kode').val(), dept_id:dept_id, lokasi_tujuan : $('#lokasi_tujuan').val(), barcode_id : $('#barcode_id').val()},
        success: function(data){
          if(data.sesi == "habis"){
              //alert jika session habis
