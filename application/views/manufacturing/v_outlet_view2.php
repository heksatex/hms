                        ...
                        <form class="form-horizontal">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="col-lg-6 col-xs-6 col-md-6 load_inlet">
                                        <!-- small box -->
                                        <div class="small-box bg-red">
                                            <div class="inner">
                                                <h3 id="jml_lot_blm_inlet">0</h3>

                                                <p>KP/Lot Belum Inlet</p>
                                            </div>
                                            <!-- <div class="icon">
                                                <i class="fa fa-shopping-cart"></i>
                                            </div> -->
                                            <a href="#" class="small-box-footer" onClick="cek_info_kp(0)" >
                                    ...
                                    <div class="col-lg-6 col-xs-6 col-md-6 load_inlet" >
                                        ...
                                        <div class="small-box bg-green-active">
                                            <div class="inner">
                                                <h3 id="jml_lot_inlet">0</h3>

                                                <p>KP/Lot Sudah Inlet</p>
                                            </div>
                                            <!-- <div class="icon">
                                                <i class="fa fa-shopping-cart"></i>
                                            </div> -->
                            ...
                            <!-- /form group -->
                            <div class="col-md-8">
                                <div class="col-md-5 pad-left-right load_data_inlet">
                                ...
                                <div class="col-md-2 pad-left-right load_data_inlet">
                                    <div class="form-group" style="margin-bottom:0px;">
