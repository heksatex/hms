    ...
    $("#btn-print-barcode").off("click").on("click",function(e) {
        ...
        if(desain_barcode.length === 0){
            ...
            $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: '<?php echo base_url('warehouse/splitlot/print_barcode_split')?>',
                    beforeSend: function(e) {
                        if (e && e.overrideMimeType) {
                            e.overrideMimeType("application/json;charset=UTF-8");
                        }
                    },
                    data: { kode_split:kode, k3l:k3l, desain_barcode:desain_barcode, data_print:myCheckboxes_arr
                    },
