...
<script type="text/javascript">
    ...
    $("#get_coa_def").off("click").on("click", function(e) {
        ...
        if (!kode_coa_default_credit ||  !nama_coa_default_credit) {
            alert_notify('fa fa-warning', "CoA  Default Credit Belum di Setting", 'danger', function() {}, 1000);
            return;
        }
        ...
        if (!kode_coa_default_debit ||  !nama_coa_default_debit) {
            alert_notify('fa fa-warning', "CoA Default Debit Belum di Setting", 'danger', function() {}, 1000);
            return;
        }
