...
<script type="text/javascript">
    ...
    $("#tambah_data .modal-dialog .modal-content .modal-footer").html('<button type="button" id="btn-edit-invoice" class="btn btn-primary btn-sm"> Simpan</button> <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Tutup</button>');
    
    
    // btn tambah
    $("#btn-edit-invoice").unbind("click");
    $("#btn-edit-invoice").off("click").on("click", function(e) {
        e.preventDefault();
        ...
        $('#btn-edit-invoice').button('loading');
