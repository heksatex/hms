...
<script type="text/javascript">
    ...
    $("#tambah_data .modal-dialog .modal-content .modal-footer").html('<button type="button" id="btn-simpan-koreksi" class="btn btn-primary btn-sm"> Simpan</button> <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Tutup</button>');
    ...
    function initSelectFaktur(target) {
        ...
        target.select2({
            ...
            allowClear: true,
            ajax: {
                url: "<?php echo base_url(); ?>finance/pelunasanpiutang/get_list_faktur",
                type: "POST",
                dataType: "json",
                delay: 250,
                data: function(params) {
    ...
    function initSelectCoa2(target) {
        ...
        target.select2({
            ...
            ajax: {
                dataType: 'JSON',
                type: "POST",
                url: "<?php echo base_url(); ?>finance/pelunasanhutang/get_list_coa",
                data: function(params) {
                    return {
                        name: params.term,
                    };
    ...
    function get_coa_default(put, koreksi, posisi, no_pelunasan, id_summary) {
        $.ajax({
            url: "<?php echo base_url(); ?>finance/pelunasanhutang/get_default_coa",
            type: "POST",
            dataType: "json",
            data: {
                koreksi: koreksi,
        ...
        $('.koreksi-select').select2({
            ...
            ajax: {
                ...
                data: function(params) {
                    return {
                        name: params.term || "",
                        // tipe: 'koreksi', // hardcode koreksi krna um bisa di split
                        currency: currency
                    };
                },
                processResults: function(data) {
    ...
    $(document).on('select2:select', '.koreksi-select', function(e) {
        ...
        let currentPosisi = row.find('.posisi_item').val();
        // simpan data get_coa
        ...
        if (get_coa === 'false') {
            ...
            row.find('.posisi_item').val(currentPosisi || posisi_item);
    ...
    // btn tambah
    $("#btn-simpan-koreksi").unbind("click");
    $("#btn-simpan-koreksi").off("click").on("click", function(e) {
        e.preventDefault();
        ...
        if (!mode) {
            ...
            // =================== SIMPAN DATA ====================
            $('#btn-simpan-koreksi').button('loading');
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('finance/pelunasanhutang/save_koreksi') ?>",
                data: payload,
                dataType: "json",
                success: function(data) {
                    ...
                    $('#btn-simpan-koreksi').button('reset');
                },
                error: function(xhr, ajaxOptions, thrownError) {
                    unblockUI(function() {});
                    $('#btn-simpan-koreksi').button('reset');
