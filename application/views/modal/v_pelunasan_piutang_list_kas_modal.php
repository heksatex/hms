<div class="row">
    <div class="col-md-12 table-responsive over">
        <table id="tbl-list-kas" class="table table-condesed table-hover rlstable over" width="100%">
            <thead>
                <tr>
                    <th class="no"></th>
                    <th class="no">No</th>
...
<script>
    $(function() {
        const table = $("#tbl-list-kas").DataTable({
            "iDisplayLength": 50,
            "processing": true,
            "serverSide": true,
            "order": [],
            ...
            "stateSave": false,
            "ajax": {
                "url": "<?php echo site_url('accounting/pelunasanpiutang/list_data_kas_bank') ?>",
                "type": "POST",
                "data": function(d) {
