                                            ...
                                            <div class="col-md-12 table-responsive over">
                                                <div class="row" style="margin-bottom:5px;">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-4">
                                                            <button class="btn btn-default btn-sm" id="btn-inv" name="btn-inv"><i class='fa fa-file-text' style='color: orange'></i> Invoice (<span id='tinv'>0</span>)</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row" style="margin-bottom:5px;">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-10 col-lg-9">
                                                            <button class="btn btn-default btn-sm" id="btn-kas-bank" name="btn-kas-bank"><i class='fa fa-bank' style='color: green'></i> Buat Kas Bank </button>
        ...
        $(function() {
            ...
            $('#btn-simpan').click(function() {
                ...
                if (partner == '' || partner == null) {
                    alert_notify('fa fa-warning', 'Supplier Harus diisi !', 'danger', function() {});
                } else {
                    ...
                    $.ajax({
                        type: "POST",
                        dataType: "json",
                        url: '<?php echo base_url('finance/pelunasanhutang/simpan') ?>',
                        data: {
                            kode: '',
                            partner: $('#partner').val(),
