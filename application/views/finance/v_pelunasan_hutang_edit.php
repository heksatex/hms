                                                ...
                                                <div class="row" style="margin-bottom:5px;">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-9 col-lg-7">
                                                            <button class="btn btn-sm btn-default <?php echo ($list->status == 'cancel' || $list->status == 'done') ? 'hidden' : ''; ?>" id="btn-kas-bank" name="btn-kas-bank" <?php echo ($list->status == 'cancel' || $list->status == 'done') ? 'disabled' : ''; ?>><i class='fa fa-bank' style='color: green'></i> Buat Kas Bank</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="col-md-12 col-xs-12">
                                                        ...
                                                        <div class="col-xs-8">
                                                            <?php $link = site_url('finance/jurnalentries/edit/' . encrypt_url($list_jurnal->kode)) ?>
    ...
    <script>
        $(function() {
            ...
            $(document).on('click', '#btn-edit', function(e) {
                ...
                $("#btn-exception").hide(); //sembuyikan btn-exception
            ...
            $(document).on('click', '#btn-cancel-edit', function(e) {
                ...
                $("#btn-exception").show(); //tampilkan btn-exception
            ...
            function get_total_by_partner(id) {
                ...
                $.ajax({
                    type: "POST",
                    dataType: "JSON",
                    url: "<?php echo base_url('finance/pelunasanhutang/get_total_by_partner') ?>",
                    data: {
                        partner: partner
                    },
            ...
            $('#partner').select2({
                ...
                ajax: {
                    dataType: 'JSON',
                    type: "POST",
                    url: "<?php echo base_url(); ?>finance/pelunasanhutang/get_list_supplier",
            ...
            function simpanData(params) {
                ...
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: baseUrl + 'finance/pelunasanhutang/simpan',
                    data: {
                        kode: $('#kode').val(),
                        partner: $('#partner').val(),
                ...
                bootbox.confirm({
                    ...
                    callback: function(result) {
                        ...
                        if (result == true) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: '<?php echo base_url('finance/pelunasanhutang/confirm_pelunasan_hutang') ?>',
                                dataType: 'JSON',
                                data: {
                ...
                bootbox.confirm({
                    ...
                    callback: function(result) {
                        ...
                        if (result == true) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: '<?php echo base_url('finance/pelunasanhutang/cancel_pelunasan_hutang') ?>',
                                dataType: 'JSON',
                                data: {
                                    no_pelunasan: no_pelunasan,
                                },
            ...
            $("#btn-exception").unbind("click");
            $(document).on('click', '#btn-exception', function(e) {

                var no_pelunasan = "<?php echo $list->no_pelunasan; ?>";
                var btn_load = $(this);
                bootbox.confirm({
                    message: "Apakah Anda ingin mengubah status Data Pelunasan ini ke Exception  ?",
                    title: "<i class='fa fa-warning' ></i> Exception !",
                    buttons: {
                        confirm: {
                            label: 'Yes',
                            className: 'btn-primary btn-sm'
                    ...
                    callback: function(result) {
                        ...
                        if (result == true) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: '<?php echo base_url('finance/pelunasanhutang/exception_pelunasan_hutang') ?>',
                                dataType: 'JSON',
                                data: {
                                    no_pelunasan: no_pelunasan,
                                },
            ...
            $("#btn-inv").on("click", function(e) {
                ...
                $.post("<?= base_url('finance/pelunasanhutang/get_view_invoice') ?>", {
            ...
            $("#btn-kas-bank").on("click", function(e) {
                ...
                $("#tambah_data .modal-dialog .modal-content .modal-body").addClass('kas_bank');
                $("#tambah_data .modal-dialog .modal-content .modal-footer").html('<button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Tutup</button>');
                $(".tambah_data").html('<center><h5><img src="<?php echo base_url('dist/img/ajax-loader.gif') ?> "/><br>Please Wait...</h5></center>');
                $('.modal-title').text('List Kas Bank');
                $("#tambah_data").removeClass('modal fade lebar_mode').addClass('modal fade lebar');
                $.post("<?= base_url('finance/pelunasanhutang/get_view_kas_bank') ?>", {
                    no_pelunasan: "<?php echo $list->no_pelunasan; ?>",
                    partner: $("#partner").val(),
                    type: 'kas',
                }, function(data) {
            ...
            $("#btn-retur").on("click", function(e) {
                ...
                $("#tambah_data").removeClass('modal fade lebar_mode').addClass('modal fade lebar');
                $.post("<?= base_url('finance/pelunasanhutang/get_view_retur') ?>", {
                    no_pelunasan: "<?php echo $list->no_pelunasan; ?>",
                    partner: $("#partner").val()
                }, function(data) {
                    setTimeout(function() {
            ...
            function distribusi_invoice(id, no_inv) {
                ...
                $.post("<?= base_url('finance/pelunasanhutang/get_view_edit_distribusi') ?>", {
            ...
            function koreksi_kurs() {
                ...
                $.post("<?= base_url('finance/pelunasanhutang/get_view_koreksi_kurs') ?>", {
                    no_pelunasan: "<?= $list->no_pelunasan; ?>",
                    partner: "<?= $list->partner_id; ?>",
                }, function(data) {
                    setTimeout(function() {
                ...
                bootbox.confirm({
                    ...
                    callback: function(result) {
                        ...
                        if (result == true) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: '<?php echo base_url('finance/pelunasanhutang/delete_pelunasan_hutang_invoice') ?>',
                                dataType: 'JSON',
                                data: {
                                    no_pelunasan: no_pelunasan,
                                    id: id,
                ...
                bootbox.confirm({
                    ...
                    callback: function(result) {
                        ...
                        if (result == true) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: '<?php echo base_url('finance/pelunasanhutang/delete_pelunasan_hutang_metode') ?>',
                                dataType: 'JSON',
                                data: {
                                    no_pelunasan: no_pelunasan,
                                    id: id,
            ...
            function loadResume() {
                ...
                $.ajax({
                    type: "POST",
                    dataType: "JSON",
                    url: "<?php echo site_url('finance/pelunasanhutang/loadData') ?>",
                    data: {
                        id: id,
                        no_pelunasan: no_pelunasan,
                        load: 'resume'
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data.record, function(key, value) {
                            ...
                            let linkUrl = value.no_bukti;
                            if(status === 'done' || status === 'cancel') {
                                if (value.tipe2 === 'bank') {
                                    linkUrlt = "<?php echo site_url('finance/bankkeluar/edit/') ?>" + value.no_encr;
                                    linkUrl  = "<a href='" + linkUrlt +"' target='_blank'>"+ value.no_bukti +"</a>";
                                } 
                            }
            ...
            function initSelectKoreksi() {
                ...
                $('.select-koreksi').select2({
                    ...
                    ajax: {
                        dataType: 'json',
                        type: "POST",
                        url: "<?php echo base_url(); ?>finance/pelunasanhutang/get_list_koreksi_select2",
                        data: function(params) {
            ...
            function loadCoaInfo(summaryId, $target) {
                $.ajax({
                    url: "<?php echo site_url('finance/pelunasanhutang/getCoaByKoreksi') ?>",
                    type: "POST",
                    dataType: "JSON",
                    data: {
            ...
            $(document).on("click", ".btn-hapus-koreksi", function(e) {
                ...
                $.ajax({
                    url: "<?php echo site_url('finance/pelunasanhutang/delete_koreksi') ?>",
                    type: "POST",
                    dataType: "JSON",
                    data: {
            ...
            $(document).on("click", ".btn-tambah-koreksi", function(e) {
                ...
                let no_pelunasan = "<?= $list->no_pelunasan; ?>";
                $.ajax({
                    url: "<?php echo site_url('finance/pelunasanhutang/save_koreksi2') ?>",
                    type: "POST",
                    dataType: "JSON",
                    data: {
                        id_summary: id_summary,
            ...
            function koreksi(id_summary, tipe_currency, tipe_koreksi) {
                ...
                $.post("<?= base_url('finance/pelunasanhutang/get_view_koreksi') ?>", {
                    no_pelunasan: "<?= $list->no_pelunasan; ?>",
                    id: id_summary,
            ...
            function detail_origin(origin) {
                ...
                $.post("<?= base_url('finance/pelunasanhutang/get_view_origin') ?>", {
                        no_pelunasan: "<?= $list->no_pelunasan; ?>",
                        origin: origin,
                    })
                    .done(function(data) {
