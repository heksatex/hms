    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><b>Report Harian</b></h3>
        </div>
        <div class="box-body">
                ...
                <div class="form-group"> 
                  ...
                  <div class="col-md-12 col-xs-12">
                    ...
                    <div class="col-xs-8 col-md-8">
                      <select class="form-control input-sm" name="mo" id="mo">
...
<script type="text/javascript">
    ...
    $(document).on('click',"#btn-generate",function(e){
      ...
      if(departemen == null){
        ...
        var url = '<?php echo base_url() ?>report/printmo/report_harian';
        window.open(url+'?departemen='+ departemen+'&&mo='+ mo,'_blank');
      }
