    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><b>HPH Inspecting2</b></h3>
        </div>
        <div class="box-body">
...
<script type="text/javascript">
  ...
  $('#btn-excel').click(function(){
    ...
    //   alert_modal_warning('Maaf, Periode Tanggal tidak boleh lebih dari 31 hari !')
      ...
      $.ajax({
          "type":'POST',
          "url": "<?php echo site_url('report/HPHinspecting2/export_excel_hph')?>",
  ...
  $("#btn-generate").on('click', function(){
      ...
      //   alert_modal_warning('Maaf, Periode Tanggal tidak boleh lebih dari 31 hari !')
          ...
          $.ajax({
                type: "POST",
                dataType : "JSON",
                url : "<?php echo site_url('report/HPHinspecting2/loadData')?>",
                data: {tgldari:tgldari, tglsampai:tglsampai, mo:mo, corak:corak, mc:mc, lot:lot, sales_order:sales_order, sales_group:sales_group,no_go:no_go, warna:warna,  user:user, jenis:jenis, shift :checkboxes_arr,reproses:reproses },
