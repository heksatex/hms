            ...
            <div class="box ">
                ...
                <div class="box-body ">
                    <div class="col-md-12" style="margin-bottom:10px" >
                        ...
                        <button type='button' class='btn btn-default btn-block' onclick="location.href='<?php echo base_url();?>report/marketing/readygoodscategorychangednmb'"><i class='fa fa-file-text-o'></i> Report Ready Changed Goods Category NMB (GJD)</button>
