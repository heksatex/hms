    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><b>Pengiriman Harian</b></h3>
        </div>
        <div class="box-body">
...
<script type="text/javascript">
  ...
  $('#btn-excel').click(function(){
    ...
    //   alert_modal_warning('Maaf, Periode Tanggal tidak boleh lebih dari 30 hari !')
      ...
      $.ajax({
          "type":'POST',
          "url" : "<?php echo site_url('report/pengirimanharian/export_excel_out')?>",
          "data": {tgldari:tgldari, tglsampai:tglsampai, departemen:departemen, dept_tujuan:dept_tujuan, status_arr:checkboxes_arr, kode:kode, corak:corak, view_arr:radio_arr, reff_note:reff_note},
          "dataType":'json',
          beforeSend: function() {
