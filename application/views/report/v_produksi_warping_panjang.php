    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><b>Jadwal Produksi Warping Panjang</b></h3>
        </div>
        <div class="box-body">
                      ...
                      <table id="example1" class="table" border="0">
                          <thead>
                            <tr>
                              ...
                              <th  class='style'>Jenis Benang</th>
...
<script type="text/javascript">
    ...
    function createBody(pageNum){
      ...
      $.ajax({
        type : 'POST',
        dataType: 'json',
        url  : '<?=base_url()?>report/produksiwarpingpanjang/loadData/'+pageNum,
        data : {id_dept : 'WRP', data_filter : arr_filter},
    ...
    $(document).on("click","#btn-filter",function(e) {
        ...
        if(filter == true && empty_value == false){
          ...
          $.ajax({
              type: "POST",
              dataType: "JSON",
              url : '<?php echo site_url('report/produksiwarpingpanjang/loadData/0') ?>',
  ...
  function get_condition(row){
    ...
    $.ajax({
        type : 'POST',
        dataType: 'json',
        url : '<?php echo site_url('report/produksiwarpingpanjang/conditionFilter') ?>',
