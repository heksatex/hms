    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><b>HPH Tricot</b></h3>
        </div>
        <div class="box-body">
...
<script type="text/javascript">
  ...
  $('#btn-excel').click(function(){
    ...
    if(tglsampai_2 < tgldari_2){ // cek validasi tgl sampai kurang dari tgl Dari
      ...
      $.ajax({
          "type":'POST',
          "url" : "<?php echo site_url('report/HPHtricot/export_excel_hph')?>",
                  ...
                  if(data.status == 'failed'){
                    ...
                    $.each(data.record, function(key, value){
                        ...
                        var tr = $("<tr>").append(
                                 ...
                                 $("<td "+color+">").text(value.qty1),
                                 $("<td "+color+">").text(value.uom1),
                                 $("<td "+color+">").text(value.qty2),
                    ...
                    if(empty == true){
                      var tr = $("<tr>").append($("<td colspan='18' >").text('Tidak ada Data'));
                      tbody.append(tr);
                    }
