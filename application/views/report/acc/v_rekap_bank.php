        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="box">
                        <div class="box-body">
                            <form id="form-search" name="form-search" class="form-horizontal form-search" action="<?= base_url('report/rekapbank/export') ?>" method="post">
...
//                    autoUpdateInput: false,
                ...
                $("#search").on("click", function () {
                    $.ajax({
                        url: "<?= base_url('report/rekapbank/search') ?>",
                        type: "POST",
                        data: {
                            tanggal: $("#tanggal").val(),
