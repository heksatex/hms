        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="box">
                        <div class="box-body">
                            <form id="form-search" name="form-search" class="form-horizontal form-search" action="<?= base_url('report/rekapkaskecil/export') ?>" method="post">
                                        ...
                                        <div class="col-md-12 col-xs-12">
                                            <div class="form-group">
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="col-xs-3">
                                                        <label class="form-label">Kas Kecil</label>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12 col-xs-12">
                                                            ...
                                                            <div class="col-xs-9 col-md-9">
                                                                ...
                                                                <input type="hidden" class="form-control" name="kode_coa" id="kode_coa" value="1111.02">
                                                            </div>
                                                        </div>
...
//                    autoUpdateInput: false,
                ...
                $("#search").on("click", function () {
                    $.ajax({
                        url: "<?= base_url('report/rekapkaskecil/search') ?>",
                        type: "POST",
                        data: {
                            tanggal: $("#tanggal").val(),
