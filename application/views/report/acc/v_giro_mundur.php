        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="box">
                        <div class="box-body">
                            <form id="form-search" name="form-search" class="form-horizontal form-search" action="<?= base_url('report/giromundur/export') ?>" method="post">
                                ...
                                <div role="region" aria-labelledby="HeadersCol" tabindex="0" class="rowheaders">
                                    <table id="tblgiro" class="table table-condesed table-hover" border="1">
                                        <tr>
                                            ...
                                            <th class="style bb ws text-right">Baru</th>
                                            <th class="style bb ws text-right">Cair</th>
...
//                    autoUpdateInput: false,
                ...
                $("#search").on("click", function () {
                    $.ajax({
                        url: "<?= base_url('report/giromundur/search') ?>",
                        type: "POST",
                        data: {
                            tanggal: $("#tanggal").val(),
