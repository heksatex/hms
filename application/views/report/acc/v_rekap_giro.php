        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="box">
                        <div class="box-body">
                            <form id="form-search" name="form-search" class="form-horizontal form-search" action="<?= base_url('report/rekapgiro/export') ?>" method="post">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <div class="col-md-12 col-xs-12">
                                                            ...
                                                            <div class="col-xs-9 col-md-9">
                                                                <input type="text" class="form-control" name="no_bg" id="no_bg">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12 col-xs-12">
                                                            <div class="col-xs-3">
                                ...
                                <div role="region" aria-labelledby="HeadersCol" tabindex="0" class="rowheaders">
                                    <table id="tblgiro" class="table table-condesed table-hover" border="1">
                                        <tr>
                                            ...
                                            <th class="style bb ws">Giro</th>
                                            <th class="style bb ws">Tanggal</th>
                                            <th class="style bb ws">Bank</th>
                                            <th class="style bb ws">No Cek/BG</th>
...
//                    autoUpdateInput: false,
                ...
                $("#search").on("click", function () {
                    $.ajax({
                        url: "<?= base_url('report/rekapgiro/search') ?>",
                        type: "POST",
                        data: {
                            tanggal: $("#tanggal").val(),
