...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table_group').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('report/marketing/get_data_ready_goods_group_colour_nmb')?>",
                "type": "POST",
                "data": {"proofing":"<?php echo $proofing;?>","product":"<?php echo $product;?>", "lebar_jadi":"<?php echo $lebar_jadi; ?>", "uom_lebar_jadi":"<?php echo $uom_lebar_jadi; ?>", "uom_jual":"<?php echo $uom_jual; ?>"}
            },
