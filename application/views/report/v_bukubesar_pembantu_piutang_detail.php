            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title"><b>Buku Besar Pembantu Piutang Detail</b></h3>
                    </div>
                    <div class="box-body">
    ...
    <script type="text/javascript">
        ...
        function process_bukubesar(this_btn) {
            ...
            $.ajax({
                type: "POST",
                dataType: "JSON",
                url: "<?php echo site_url('report/bukubesarpembantupiutangdetail/loadData') ?>",
                data: {
                    tgldari: tgldari,
                    tglsampai: tglsampai,
                ...
                success: function(data) {
                    ...
                    if (data.status == 'failed') {
                        ...
                        $.each(data.record, function(key, value) {
                            ...
                            var tr = $("<tr>").append(
                                // $("<td>").text(''),
                                $("<td class='text-left' colspan='4'>").html('<b>Customer : </b>' + value.nama_partner),
                                $("<td colspan='3'>").text(''),
                            );
                            tbody.append(tr);
                            ...
                            $.each(value.tmp_data_isi, function(key, value2) {
                                ...
                                if (value2.link === 'plp' || value2.link === 'ret' || value2.link === 'fak' || value2.link === 'kab') {
        ...
        $('#btn-excel').click(function() {
            ...
            if (arr_filter.length == 0) {
                ...
                $.ajax({
                    "type": 'POST',
                    "url": "<?php echo site_url('report/bukubesarpembantupiutangdetail/export_excel') ?>",
                    "data": {
