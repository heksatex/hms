                            ...
                            <table class="table table-condesed table-hover rlstable over" width="100%" id="table_group" >
                                <thead>                          
                                    <tr>
                                        ...
                                        <th class="style  text-right">Qty 1</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table_group').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('report/marketing/get_data_stock_by_product_group')?>",
                "type": "POST",
                "data": {"product": "<?php echo $product;?>", "color":"<?php echo $color; ?>", "marketing":"<?php echo $mkt?>"}
            },
