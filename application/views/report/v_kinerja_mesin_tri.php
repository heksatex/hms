        ...
        <script>
            ...
            const  asDataGrafik = (() => {
                return $.ajax({
                    ...
                    url: "<?= base_url("report/kinerjamesin/get_grafiks/{$dept}"); ?>",
            ...
            async function renderChart() {
                await asDataGrafik().then((res) => {
                    ...
                    dt.forEach((sd, idx) => {
                        ...
                        totals[sd.shift_range]["nyucuk"] += parseInt(sd.nyucuk);
                    ...
                    ["pagi", "siang", "malam"].forEach(shift => {
                        ...
                        totals[shift]["nyucuk"] = (totals[shift]["nyucuk"] / 60).toFixed(2);
                ...
                const options = {
                    ...
                    legend: {
                        data: ['Running', 'No Response', 'Ganti Benang', 'Putus/Problem', 'Nyucuk', 'No Order'],
                        bottom: '0%',
                        icon: 'rect',
                        itemWidth: 12,
                        itemHeight: 12,
                    ...
                    series: [
                        ...
                        {
                            name: 'Nyucuk', type: 'bar',
                            itemStyle: {color: '#B27272', borderRadius: [4, 4, 0, 0]},
                            label: {show: true, position: 'top', formatter: p => p.value > 0 ? p.value : '', textStyle: {fontSize: 10, color: '#64748b'}},
                            data: [totals["pagi"].nyucuk, totals["siang"].nyucuk, totals["malam"].nyucuk]
                        },
                        {
            ...
            function renderTable() {
                ...
                ["pagi", "siang", "malam"].forEach(shift => {
                    ...
                    textHours.nyucuk = converMinute(s.nyucuk);
                ...
                <tr>
                    ...
                    <td class="mono text-warning fw-semibold">${textHours.problem}</td>
                        <td class="mono" style="color:#B27272">${textHours.nyucuk}</td>
