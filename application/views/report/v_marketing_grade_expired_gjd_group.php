                      ...
                      <div class="row col-md-6">
                        <div class="form-group "> 
                            <div class="col-md-12 col-xs-12">
                                ...
                                <div class="col-xs-8"><label>:</label> <?php echo $grade; ?></div>
                            </div>
                            <div class="col-md-12 col-xs-12">
                                <div class="col-xs-4"><label>Expired</label></div>
                                <div class="col-xs-8"><label>:</label> <?php echo $expired; ?></div>
                            </div>
                        </div>
                      </div>
                      </div>
                            ...
                            <table class="table table-condesed table-hover rlstable over" width="100%" id="table_group" >
                                <thead>                          
                                    <tr>
                                        ...
                                        <th class="style ws text-right">Qty1</th>
                                        <th class="style ws">Uom1</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table_group').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('report/marketing/get_data_stock_expired_grade_group')?>",
                "type": "POST",
                "data": {"product": "<?php echo $product;?>", "color":"<?php echo $color; ?>", "marketing":"<?php echo $mkt?>", "grade":"<?php echo $grade;?>", "expired":"<?php echo $expired;?>"}
            },
