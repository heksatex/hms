    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><b>Jadwal Produksi Cutting Shearing</b></h3>
        </div>
        <div class="box-body">
...
<script type="text/javascript">
    ...
    function createBody(pageNum){
      ...
      $.ajax({
        type : 'POST',
        dataType: 'json',
        url  : '<?=base_url()?>report/produksicuttingshearing/loadData/'+pageNum,
        data : {id_dept : 'CS', data_filter : arr_filter},
       ...
       $("#example1_processing").css('display','');
        ...
        if(filter == true){
          ...
          $.ajax({
              type: "POST",
              dataType: "JSON",
              url : '<?php echo site_url('report/produksicuttingshearing/loadData') ?>',
  ...
  $('#btn-excel').click(function(){
    ...
    if(query.length == 0){ 
      ...
      $.ajax({
          "type":'POST',
          "url": "<?php echo site_url('report/produksicuttingshearing/export_excel')?>",
          "data": {query:query},
          "dataType":'json',
          beforeSend: function() {
