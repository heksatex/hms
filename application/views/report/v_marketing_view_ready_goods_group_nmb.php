...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table_group').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('report/marketing/get_data_ready_goods_group_nmb')?>",
                "type": "POST",
                 "data": function ( data ) {
    ...
    $('#btn-excel').click(function(){
        $.ajax({
            "type":'POST',
            "url": "<?php echo site_url('report/Marketing/export_excel_ready_goods_group_nmb')?>",
