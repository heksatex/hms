    ...
    <body style="padding:  0 30px 0 30px;font-size: 10px;">
        ...
        <div id="row">
            ...
            <div id="column" style="line-height: 0.5;">
                <h2><strong>BUKTI GIRO MASUK</strong></h2>
                <p><?= $head->nama_coa ?></p>
                <p><?= "No Acc (Debet) : {$head->kode_coa}" ?></p>
            </div>
        ...
        <div id="row"style="line-height: 0.5;">
            ...
            <table cellspacing="0" style="width: 100%;border-collapse: collapse;">
                <tr>
                    ...
                    <th style="width: 80px;text-align: left;">Bank</th>
                    <th style="width: 80px;text-align: left;">No Rek</th>
                    <th style="width: 80px;text-align: left">No/Cek BG</th>
                    <th style="width: 80px;text-align: left">Tgl JT</th>
                    <th style="width: 90px">No Acc(Kredit)</th>
                    <th style="width: 80px;text-align: right;">Kurs</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?= date("d-m-Y", strtotime($value->tgl_jt)) ?>
                        </td>
                        <td>
                            <?= $value->kode_coa ?>
                        </td>
