        ...
        <?php foreach ($data as $key => $data) { ?>
            <div class="container" id="#is1i">
                <div class="row">
                    <div class="col-xs-4">
                        <div class="row">
                            <div class="data-center">
                                ...
                                <div id="noregk3l">
                                    <div id="iop3i">Packing List <span style="font-weight:600;"><?= $data["pl"] ?? "" ?></span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xs-4">
                        <div class="row">
                            <div class="data-center data-center-rotate">
                                <div class="divss translate-rotate">
                                    <div class="text-rotate"></div>
                                    <div class="text-rotate" style="font-size: 150%;font-weight: 400; text-align: center;">BULK<p>EXPORT</p></div>
                                    <div class="text-rotate"></div>
                                </div>
                            </div>
                    ...
                    <div class="col-xs-4">
                        <div class="row">
                            <div class="data-center data-center-rotate">
                                ...
                                <div class="divss translate-rotate" style="font-size: 90%;font-weight: 400; margin-left: -20%">
                                    <div class="text-rotate"></div>
