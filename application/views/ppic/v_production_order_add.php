            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="col-md-12 col-xs-12">
                  ...
                  <div class="col-xs-8">
                    ...
                    <input type="hidden" class="form-control input-sm" name="kode_prod_en" id="kode_prod_en"  readonly="readonly" />
                  </div>                                    
                </div>
                <div class="col-md-12 col-xs-12">
              ...
              <div class="col-md-6">
                <div class="col-md-12 col-xs-12">
                  ...
                  <div class="col-xs-8 col-md-8">
                    <div class='input-group date dtp' id='tanggal' >
...
<script type="text/javascript">
  ...
  $(document).on('click','.sc',function(e){
      ...
      $('.modal-title').text('View Sales Order');
        $.post('<?php echo site_url()?>ppic/productionorder/list_sales_order_modal',
          function(html){
...
//pilih data pada modal view sales order
         ...
         data: {kode_prod   : $('#kode_prod').val(),
            ...
            if(data.sesi == "habis"){
             ...
             //jika berhasil disimpan/diubah
              ...
              $('#kode_prod_en').val(data.kode_encrypt);
              unblockUI( function() {
                setTimeout(function() { 
                  alert_notify(data.icon,data.message,data.type, function(){
                   
                  window.location.replace('edit/'+$('#kode_prod_en').val());
                },1000); 
                });
              });
            }
