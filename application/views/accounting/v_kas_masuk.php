                    ...
                    <div class="box">
                        <div class="box-body">
                            ...
                            <div class="col-xs-12 table-responsive">
                                <table id="tbl-km" class="table table-striped">
                                    <thead>
                                        <tr>
                                            <th class="no">No</th>
                                            <th>No Bukti</th>
        ...
        <script>
            ...
            $(function () {
                $("#btn-tambah").on("click", function () {
                    window.location.href = "<?php echo site_url("{$class}/kasmasuk/add") ?>";
                });
                const table = $("#tbl-km").DataTable({
                    "iDisplayLength": 50,
                    "processing": true,
                    "serverSide": true,
                    "order": [],
                    ...
                    "autoWidth": false,
                    "ajax": {
                        "url": "<?php echo site_url("{$class}/kasmasuk/list_data") ?>",
                        "type": "POST",
                        "data": function (d) {
                            d.tanggal = tanggal;
                ...
                $("#export").on("click", function (e) {
                    e.preventDefault();
                    $.ajax({
                        url: "<?= base_url('accounting/kasmasuk/ekspor/') ?>",
                        type: "POST",
                        data: {
                            tanggal: $("#tanggal").val(),
