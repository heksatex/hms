        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="box">
                        <form class="form-horizontal" method="POST" name="form-acc-kaskecil" id="form-acc-kaskecil" action="<?= base_url("accounting/kaskecilkeluar/update/{$id}") ?>">
                            <input type="hidden" value="<?= $datas->id ?>" name="ids">
                            <div class="box-header with-border">
                                <h3 class="box-title"><strong><?= $datas->no_kkk ?></strong></h3>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12 col-xs-12">
                                                ...
                                                <div class="col-xs-8 col-md-8">
                                                    <select class="form-control input-sm select2 no_acc edited" name="no_acc" disabled style="width: 100%">
                                                        <option value=""></option>
                                                        <?php
            ...
            <template class="kaskeluar-tmplt">
                <tr class="add-fpt-tr list-new">
                    ...
                    <td>
                        <input type="text" pattern="^-?\d{1,3}(,\d{3})*(\.\d+)?$" data-type='currency' name="nominal[]" class="form-control nominal nominal:nourut text-right input-sm" value="0" required/>
                    </td>
                </tr>
            </template>
            <script>
...
//                        if (this.value !== "")
                ...
                $(function () {
                    ...
                    const updateStatus = ((statuss) => {
                        $.ajax({
                            url: "<?= base_url("accounting/kaskecilkeluar/update_status/{$id}") ?>",
                    ...
                    $("#btn-confirm").unbind("click").off("click").on("click", function (e) {
                        ...
                        confirmRequest("Kas Kecil Keluar", statuss + " Data ? ", (() => {
                    ...
                    $("#btn-draft").unbind("click").off("click").on("click", function (e) {
                        e.preventDefault();
                        confirmRequest("Kas Kecil Keluar", "Simpan Kembali Sebagai Draft ? ", (() => {
                            updateStatus("draft");
                        }));
                    });
                    ...
                    $("#btn-print").on("click", function (e) {
                        e.preventDefault();
                        $.ajax({
                            url: "<?= base_url('accounting/kaskecilkeluar/print') ?>",
                            type: "POST",
                            data: {
                                no: "<?= $id ?>"
                            },
                            ...
                            success: function (data) {
                                ...
                                window.location.href = "<?= base_url('accounting/kaskecilkeluar/add') ?>";
                            },
                            complete: function (jqXHR, textStatus) {
                                unblockUI(function () {});
                    ...
                    $.ajax({
                        url: "<?= base_url('accounting/kaskecilkeluar/print_pdf/') ?>",
                        type: "POST",
                        data: {
                            id: "<?= $id ?>"
                        },
