                ...
                <section class="content">
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <form  class="form-horizontal" method="POST" name="form-jurnal" id="form-jurnal" action="<?= base_url('accounting/jurnalentries/simpan/') ?>">
                        <div class="box-body">
            ...
            $(function () {
                ...
                $(".periode").select2({
                    ...
                    ajax: {
                        dataType: 'JSON',
                        type: "GET",
                        url: "<?php echo base_url(); ?>accounting/jurnalentries/get_periode",
                        delay: 250,
