                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td class="text-bold">
                                                            ...
                                                            <input type="text" name="total_nominal" id="total_nominal" class="form-control input-sm text-right total_nominal" 
                    ...
                    $("#btn-print").on("click", function (e) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                window.location.href = "<?= base_url('accounting/girokeluar/add') ?>";
                            },
                            complete: function (jqXHR, textStatus) {
                                unblockUI(function () {});
                            },
...
//                        setBank(no);
                    ...
                    $("#btn-print-pdf").off("click").unbind("click").on("click", function () {
                        $.ajax({
                            url: "<?= base_url('accounting/girokeluar/print_pdf/') ?>",
                            type: "POST",
                            data: {
                                id: "<?= $id ?>"
                            },
