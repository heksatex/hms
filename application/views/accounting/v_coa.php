...
<html>
    <head>
        ...
        <!--<link rel="stylesheet" type="text/css" href="<?= base_url('dist/css/ludo-treetable-theme.css'); ?>" />-->
    ...
    <body class="hold-transition skin-black fixed sidebar-mini">
                    ...
                    <div class="box">
                        <div class="box-body">
                            ...
                            <div class="col-xs-12 table-responsive">
                                <table id="tbl-gk" class="table table-condesed table-hover">
                                    <caption>
                                        <div class="pull-left">
                                            <a href="#" class="expnd">Expand all</a>
                                            ...
                                            <div class="col-md-12 col-xs-12">
                                                <form method="GET">
                                                    <div class="col-xs-8 col-md-8">
                                                        <input type="text" name="search" class="form-control input-sm" value="<?= $this->input->get("search") ?? "" ?>"/>
                                                    </div>
                                                    <div class="col-xs-4"><button class="btn btn-primary btn-sm">Search</button></div>
                                                </form>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($coa as $key => $value) {
                                            $enc = encrypt_url($value->kode_coa);
                                            ?>
                                            <tr data-tt-id="<?= "k{$value->kode_coa}" ?>" data-tt-parent-id="<?= "k{$value->parent}" ?>" >
                                                <td>
                                                    <?= $value->kode_coa ?>
                                                </td>
                                                <td>
                                                    <a href="<?= base_url("accounting/coa/edit/{$enc}") ?>"><?= $value->nama ?></a>
                                                </td>
                                                <td>
                                                    <?= $value->saldo_normal ?>
                                                </td>
                                                <td>
                                                    <?= number_format($value->saldo_valas, 2) ?>
                                                </td>
                                                <td>
        ...
        <script>
            $(function () {
                ...
                $(".clps").on("click", async function () {
                    please_wait(function () {
                        setTimeout(function () {
                            $('#tbl-gk').treetable('collapseAll');
                        }, 100);
                    });
                    unblockUI(function () {
