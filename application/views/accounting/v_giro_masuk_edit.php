        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="box">
                        <form class="form-horizontal" method="POST" name="form-acc-giromasuk" id="form-acc-giromasuk" action="<?= base_url("accounting/giromasuk/update/{$id}") ?>">
                            <div class="box-header with-border">
                                <h3 class="box-title"><strong><?= $datas->no_gm ?></strong></h3>
...
//                        if (this.value !== "")
            ...
            $(function () {
                ...
                const updateStatus = ((statuss) => {
                    $.ajax({
                        url: "<?= base_url("accounting/giromasuk/update_status/{$id}") ?>",
                ...
                $("#btn-confirm").unbind("click").off("click").on("click", function (e) {
                    ...
                    confirmRequest("Giro Masuk", statuss + " Data ? ", (() => {
                ...
                $("#btn-draft").unbind("click").off("click").on("click", function (e) {
                    e.preventDefault();
                    confirmRequest("Giro Masuk", "Simpan Kembali Sebagai Draft ? ", (() => {
                        updateStatus("draft");
                    }));
                });
                ...
                $("#btn-print").on("click", function (e) {
                    e.preventDefault();
                    $.ajax({
                        url: "<?= base_url('accounting/giromasuk/print') ?>",
                        type: "POST",
                        data: {
                            no: "<?= $id ?>"
                        },
                        ...
                        success: function (data) {
                            ...
                            window.location.href = "<?= base_url('accounting/giromasuk/add') ?>";
                        },
                        complete: function (jqXHR, textStatus) {
                            unblockUI(function () {});
...
//                    setBank(no);
                ...
                $("#btn-cancel").on("click", function (e) {
                    e.preventDefault();
                    $('#form-acc-giromasuk').trigger("reset");
                    $(this).hide();
                    $("#btn-simpan").show();
