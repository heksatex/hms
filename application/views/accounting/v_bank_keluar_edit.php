        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="box">
                        <form class="form-horizontal" method="POST" name="form-acc-bankkeluar" id="form-acc-bankkeluar" action="<?= base_url("accounting/bankkeluar/update/{$id}") ?>">
                            <div class="box-header with-border">
                                <h3 class="box-title"><strong><?= $datas->no_bk ?></strong></h3>
                                    ...
                                    <div class="field-group">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-xs-12">
                                                ...
                                                <!--                                                <div class="col-xs-4">
                                                                                                    <button type="button" class="btn btn-default btn-sm btn-edit" ><span class="glyphicon glyphicon-edit"></span> Edit </button>
                                                                                                    <button type="button" class="btn btn-default btn-sm btn-edit-cancel" style="display: none;" ><span class="glyphicon glyphicon-cancel"></span> Cancel Edit </button>
                                                                                                </div>-->
                                                <div class="col-xs-4">
                                        ...
                                        <div class="tab-pane active" id="tab_1" >
                                            <div class="table-responsive over">
                                                <table class="table table-condesed table-hover rlstable hides" width="100%" id="bankkeluar-detail" style="min-width: 100%">
                                                    ...
                                                    <th class="style" style="width: 130px">No Rek</th>
                                                    <th class="style" style="width: 130px">No.Cek/BG</th>
                                                    <th class="style" style="width: 140px">Tgl JT</th>
...
//                            xhr.setRequestHeader("_request", "json");
                ...
                $("#btn-print").on("click", function (e) {
                    e.preventDefault();
                    $.ajax({
                        url: "<?= base_url('accounting/bankkeluar/print') ?>",
                        type: "POST",
                        data: {
                            no: "<?= $id ?>"
                        },
                        ...
                        success: function (data) {
                            ...
                            window.location.href = "<?= base_url("{$class}/bankkeluar/add") ?>";
                        },
                        complete: function (jqXHR, textStatus) {
                            unblockUI(function () {});
