            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-12 col-xs-12">
                  ...
                  <div class="col-xs-8">
                    <textarea type="text" class="form-control input-sm"name="invoice_street" id="invoice_street"></textarea>
                  </div>                                    
                </div>
                <div class="col-md-12 col-xs-12">
                ...
                <div class="col-md-12 col-xs-12">
                  ...
                  <div class="col-xs-8">
                    <input type="text" class="form-control input-sm" name="invoice_city" id="invoice_city" >
                  </div>                                    
                </div>
                <div class="col-md-12 col-xs-12">
                  <div class="col-xs-4"><label>Invoice Zip </label></div>
                  <div class="col-xs-8">
                    <input type="text" class="form-control input-sm" name="invoice_zip" id="invoice_zip" >
                  </div>                                    
                </div>
                &nbsp;
                &nbsp;
                <div class="col-md-12 col-xs-12">
                  ...
                  <div class="col-xs-8">
                    <input type="text" class="form-control input-sm" name="buyer_code" id="buyer_code" >
                  </div>                                    
                </div>
                <div class="col-md-12 col-xs-12">
                  <div class="col-xs-4"><label>Website</label></div>
                  <div class="col-xs-8">
                    <input type="text" class="form-control input-sm" name="website" id="website" placeholder="e.g.  www.heksatex.co.id">
                  </div>                                    
                </div>
                <div class="col-md-12 col-xs-12">
                  <div class="col-xs-4"><label>Tax Name</label></div>
                  <div class="col-xs-8">
                    <input type="text" class="form-control input-sm" name="tax_name" id="tax_name" >
                  </div>                                    
                </div>
                <div class="col-md-12 col-xs-12">
                  <div class="col-xs-4"><label>Tax Address</label></div>
                  <div class="col-xs-8">
                    <textarea type="text" class="form-control input-sm" name="tax_address" id="tax_address" ></textarea>
                  </div>                                    
                </div>
                <div class="col-md-12 col-xs-12">
                  <div class="col-xs-4"><label>Tax City</label></div>
                  <div class="col-xs-8">
                    <input type="text" class="form-control input-sm" name="tax_city" id="tax_city" >
                  </div>                                    
                </div>
                <div class="col-md-12 col-xs-12">
                  <div class="col-xs-4"><label>NPWP</label></div>
                  <div class="col-xs-8">
                    <input type="text" class="form-control input-sm" name="npwp" id="npwp" >
                  </div>                                    
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="col-md-12 col-xs-12">
                  ...
                  <div class="col-xs-8">
                    <input type="text" class="form-control input-sm" name="contact_person" id="contact_person" >
                  </div>                                    
                </div>
                <div class="col-md-12 col-xs-12">
                ...
                <div class="col-md-12 col-xs-12">
                  ...
                  <div class="col-xs-8">
                    <input type="text" class="form-control input-sm" name="mobile" id="mobile" placeholder="e.g. 081234568" onkeyup="validAngka(this)">
                  </div>                                    
                </div>
                <div class="col-md-12 col-xs-12">
                  <div class="col-xs-4"><label>Fax</label></div>
                  <div class="col-xs-8">
                    <input type="text" class="form-control input-sm" name="fax" id="fax" >
                  </div>                                    
                </div>
                <div class="col-md-12 col-xs-12">
                  <div class="col-xs-4"><label>Email</label></div>
                  <div class="col-xs-8">
                    <input type="email" class="form-control input-sm" name="email" id="email" placeholder="e.g. hms@heksatex.co.id" >
                  </div>                                    
                </div>
                &nbsp;
                &nbsp;
            ...
            <div class="form-group">
              <div class="col-md-6">
                <div class="col-md-12 col-xs-12">
                  ...
                  <div class="col-xs-8">
                    <textarea type="text" class="form-control input-sm"name="delivery_street" id="delivery_street"></textarea>
                  </div>                                    
                </div>
                <div class="col-md-12 col-xs-12">
                ...
                <div class="col-md-12 col-xs-12">
                  ...
                  <div class="col-xs-8">
                    <input type="text" class="form-control input-sm" name="delivery_city" id="delivery_city" >
                  </div>                                    
                </div>
                <div class="col-md-12 col-xs-12">
                  <div class="col-xs-4"><label>Delivery Zip </label></div>
                  <div class="col-xs-8">
                    <input type="text" class="form-control input-sm" name="delivery_zip" id="delivery_zip" >
                  </div>                                    
                </div>
