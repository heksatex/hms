...
class M_worksheet extends CI_Model
{
    ...
    public function get_list_worksheet($tgldari, $tglsampai, $checkhidden, array $where = [])
    {
        ...
        $this->db->select(" coa.kode_coa, coa.nama as nama_coa,coa.saldo_normal,coa.saldo_awal, 
                            COALESCE(debit_sbl.total_debit, 0) as total_debit_sbl,
