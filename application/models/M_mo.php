...
class M_mo extends CI_Model
{
	...
	//var $table2 	  = 'mesin';
	var $column_order = array(null, 'kode', 'tanggal', 'nama_produk', 'qty', 'uom', 'reff_note', 'nama_status');
	var $column_search= array( 'kode', 'tanggal', 'nama_produk', 'qty','uom', 'reff_note', 'nama_status');
	...
	private function _get_datatables_query()
	{
		...
		$this->db->select("mp.kode, mp.tanggal, mp.nama_produk, mp.qty, mp.uom, mp.status, mmss.nama_status, mp.reff_note");
...
*/
	...
	{
		return $this->db->query("SELECT mp.create_date,mp.kode_produk, mp.nama_produk, mp.lot, mp.qty, mp.uom, sq.reff_note, mph.reff_note as note_head
