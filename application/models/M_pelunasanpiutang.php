...
class M_pelunasanpiutang extends CI_Model
{
    ...
    function get_list_summary_koreksi_by_id2($where)
    {
        if (count($where) > 0) {
            $this->db->where($where);
        }
