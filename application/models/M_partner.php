...
{	
	...
	//var $table        = 'partner';
	var $column_order = array(null, 'nama', 'buyer_code', 'invoice_street', 'invoice_city', 'invoice_state', 'invoice_country','invoice_zip');
